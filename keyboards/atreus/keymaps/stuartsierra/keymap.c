...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT( /* Function keys */
    ...
    KC_F21,    KC_F22,   KC_F23,  KC_F24,  RESET,                     TO(3),   TO(4),   TO(5),   KC_NO,       KC_NO,
  ...
  [4] = LAYOUT( /* QWERTY-like for games */
    KC_1,      KC_2,     KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
    KC_TAB,    KC_Q,     KC_W,    KC_E,    KC_R,                      KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,
    KC_LSFT,   KC_A,     KC_S,    KC_D,    KC_F,                      KC_V,    KC_B,    KC_N,    KC_M,    KC_NO,
    KC_ESC,    KC_Z,     KC_X,    KC_C,    KC_SPC, KC_LSFT, KC_LCTL,  KC_LALT, TO(0),   KC_COMMA,KC_DOT,  KC_ENT
  ),

  [5] = LAYOUT( /* Minecraft */
    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
    KC_ESC,  KC_NO,   KC_W,    KC_E,    KC_T,                      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_NO,
    KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,                      KC_F5,   KC_F6,   KC_F7,   KC_F11,  KC_NO,
    TO(0),   KC_NO,   KC_NO,   KC_NO,   KC_SPC,  KC_LCTL, KC_LSFT, KC_Q,    TO(0),   KC_NO,   KC_SLSH, KC_NO
  )
};
