...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT( /* Function keys */
    ...
    KC_F21,    KC_F22,   KC_F23,  KC_F24,  RESET,                     TO(3),   TO(4),   KC_NO,   KC_NO,       KC_NO,
  ...
  [4] = LAYOUT( /* QWERTY */
    ...
    TO(0),     KC_TRNS,  KC_TRNS, KC_TRNS, KC_BSPC, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MINS, KC_QUOT, KC_TRNS
  )
};
